  ...
  return (
      <main className=' max-w-md px-2 mx-auto '>
          ...
          <form>
              ...
              <input className=' w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6 ' required placeholder='Property name' maxLength="32" minLength="10" type="text" id='name' value={name} onChange={onChange} />
              
              <div>
                  <div>
                      <p className=' text-lg font-semibold '>Beds</p>
                      <input className='  w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:border-slate-600 focus:bg-white text-center' type="number" id="bedrooms" value={bedrooms} required  onChange={onChange} min='1' max='50'/>
                  </div>
                  <div>
                      <p className='  text-lg font-semibold '>Baths</p>
                      <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:border-slate-600 focus:bg-white text-center' type="number"  id="bathrooms" value={bathrooms} required  onChange={onChange} min='1' max='50'/>
                  </div>
              </div>
              ...
              </div> <p className=' text-lg mt-6 font-semibold '> Furnished</p>
              <div className='flex'>
                  <button
              ...
              <textarea className=' w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6 ' required placeholder='Address' type="text" id='address' value={address} onChange={onChange} />
               <p className='text-lg font-semibold'> Description</p>
              <textarea className=' w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6 ' required placeholder='Description' type="text" id='description' value={description} onChange={onChange} />
