        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              ...
              <p>
                <Link className=' text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out' to={"/sign-in"}>Sign in</Link>
              </p>
             
            </div>
            <button className=' hover:shadow-lg active:bg-blue-800 w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition ease-in-out duration-150' type="submit">Send reset password</button>
