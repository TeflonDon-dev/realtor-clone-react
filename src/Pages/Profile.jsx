    ...
    <>
        ...
        <div className=' w-full md:w-[50%] mt-6 px-3'>
          ...
          <form>
            ...
            <input
              ...
              id='name' value={name} disabled={!changeDetail} className={` mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out ${changeDetail && ' bg-red-200 focus:bg-red-200'}`} />
            {/* email input */}
      ...
      <div className=' max-w-6xl px-3 mt-6 mx-auto'>
        {!loading && listings.length > 0 && (
          <>
            <h2 className=' mt-6 mb-6 text-2xl text-center font-semibold'>My Listings</h2>
